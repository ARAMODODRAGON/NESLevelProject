...
public class Agent : Entity {
    ...
    protected virtual void Start() {
        ...
        Vector3 distanceToCamera = transform.position - LMTools.Camera.position;
        ...
        if (distanceToCamera.x > LMTools.ScreenSize.x || distanceToCamera.y > LMTools.ScreenSize.y) {
            isActive = false;
        } else {
            isActive = true;
        }
    ...
    protected bool CheckIsOnScreen {
        get {
            ...
            return !(distanceToCamera.x > LMTools.ScreenSize.x || distanceToCamera.y > LMTools.ScreenSize.y);
        }
    }
